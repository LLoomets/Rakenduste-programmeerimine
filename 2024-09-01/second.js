...
console.log(addNumbersArrowFn(1, 10));

// 4. Ülesanne: ümber kirjutada shorthand arrow funktsiooninaõ

const addNumbersShorthandArrowFn = (num1, num2) => num1 + num2;

// () => { return ... }
// () => (return) ...

console.log(addNumbersShorthandArrowFn(2, 5));
...
console.log(addNumbersNested(1)(99));

// 6. Ülesanne: Looge samast funktsioonist arrowfunktsioon

const addNumbersNestedFn = (num1) => (num2) => num1 + num2;

console.log(addNumbersNestedFn(34)(5));
